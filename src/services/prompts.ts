...
export const getSystemPrompt = (
  ...
  const actions = [
    ...
    '',
    '� מקטעים דינמיים (DYNAMIC SECTIONS):',
    '• section / upsertSection – הוספה או עדכון מקטע מותאם אישית',
    '• updateSection – עדכון מקטע קיים (title, layout, content)',
    '• appendSectionItems – הוספת פריטים למקטע רשימה',
    '• sections / replaceSections – החלפת כל המקטעים',
    '• removeSection / removeSectionByKey – מחיקת מקטע',
    '',
    'סוגי מקטעים:',
    '  • text – טקסט חופשי',
    '  • list – רשימת פריטים עם כותרות',
    '  • chips – תגיות/כישורים',
    '  • keyValue – זוגות מפתח-ערך',
    '',
    '�🔄 כללי:',
  ...
  const examples = [
    ...
    '',
    '// מקטע טקסט פשוט',
    '[RESUME_DATA]{"section":{"key":"volunteer","title":"פעילות התנדבותית","layout":"text","text":"מתנדב פעיל בארגון XYZ, מדריך תכנות לנוער"}}[/RESUME_DATA]',
    '',
    '// מקטע רשימה (למשל: פרסים, הסמכות, פרויקטים)',
    '[RESUME_DATA]{"section":{"key":"certifications","title":"הסמכות מקצועיות","layout":"list","items":[{"title":"AWS Certified Solutions Architect","subtitle":"Amazon Web Services","duration":"2022"},{"title":"Google Cloud Professional","subtitle":"Google","duration":"2021"}]}}[/RESUME_DATA]',
    '',
    '// מקטע תגיות (למשל: שפות, תחומי עניין)',
    '[RESUME_DATA]{"section":{"key":"languages","title":"שפות","layout":"chips","chips":["עברית - שפת אם","אנגלית - רמה גבוהה","ספרדית - בסיסי"]}}[/RESUME_DATA]',
    '',
    '// מקטע key-value (למשל: פרטים נוספים)',
    '[RESUME_DATA]{"section":{"key":"additional-info","title":"מידע נוסף","layout":"keyValue","pairs":[{"key":"זמינות","value":"מיידית"},{"key":"רישיון נהיגה","value":"B"}]}}[/RESUME_DATA]',
    '',
    '// הוספת פריטים למקטע רשימה קיים',
    '[RESUME_DATA]{"appendSectionItems":{"key":"certifications","items":[{"title":"Kubernetes Administrator","subtitle":"CNCF","duration":"2023"}]}}[/RESUME_DATA]',
    '',
    '// עדכון מקטע קיים (שינוי כותרת או תוכן)',
    '[RESUME_DATA]{"updateSection":{"key":"volunteer","updates":{"title":"התנדבות וקהילה","text":"מתנדב פעיל בארגון XYZ, מדריך תכנות לנוער, מארגן מיטאפים"}}}[/RESUME_DATA]',
    '',
    '// מחיקת מקטע',
    '[RESUME_DATA]{"removeSection":"volunteer"}[/RESUME_DATA]',
    '',
    '// החלפת כל המקטעים בבת אחת',
    '[RESUME_DATA]{"replaceSections":[{"key":"awards","title":"פרסים והכרה","layout":"list","items":[{"title":"Employee of the Year","subtitle":"Microsoft","duration":"2021"}]},{"key":"languages","title":"שפות","layout":"chips","chips":["עברית","אנגלית"]}]}[/RESUME_DATA]',
    '',
    '// ארגון מחדש כולל מקטעים',
    ...
    '[RESUME_DATA]{"reorganize":{"experiences":[...],"skills":[...],"summary":"...","contact":{...},"sections":[...]}}[/RESUME_DATA]',
    '',
  ].join('\n');
