    ...
    <div className="h-full flex items-center justify-center bg-gray-50 p-8">
      <div className="w-full max-w-4xl">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            <div className="w-16 h-16 mx-auto mb-6 bg-gradient-to-br from-gray-200 to-gray-300 rounded-full flex items-center justify-center group-hover:from-gray-300 group-hover:to-gray-400 transition-colors">
