import type { DesignTemplate } from '../features/design/types/design.types';
...
export const DESIGN_TEMPLATES: DesignTemplate[] = [
  ...
  },
  {
    ...
    name: 'Executive',
    style: 'executive',
    description: 'Sophisticated and elegant. Ideal for senior leadership and executive positions.',
    colors: {
      primary: '#0f172a',
      secondary: '#334155',
      text: '#0f172a',
